...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小马tv', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '看小马拉大车上小马tv', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xxx.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '数字花园', // 网站关键词 英文逗号隔开
